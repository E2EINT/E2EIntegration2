...
public class TC_001 {
	...
	public void testcase1() throws InterruptedException
	{
	   ...
	   /* wait.until(ExpectedConditions.attributeToBe(By.xpath(".//*[@id='block_rtx0']"),"class","unselectable textblock"));
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='hrefExit']"),"Exit"));
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));*/
