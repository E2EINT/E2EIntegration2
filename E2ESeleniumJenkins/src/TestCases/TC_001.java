...
public class TC_001 { //PowerPoint 2013 - Standard
	@Test
	public void testcase1() throws InterruptedException
	{
	    ...
	    wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
	    driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(100);
	    // Question 3
	    wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
	    ...
	    // Question 4
	    wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
	    driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr2']")).click();
	    driver.findElement(By.xpath(".//*[@id='inserttab_rtm_tr37']")).click();Thread.sleep(1000);
	    driver.findElement(By.xpath(".//*[@id='pnewslide_page_1_tr7']")).click();
	    wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
	    driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
	    // Question 5
	    wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		...
		driver.findElement(By.xpath(".//*[@id='prightpane_page_1_tr2']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='prightpane_page_2_tr1']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 6
		...
		// Question 7
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr3']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='designtab_rtm_tr6']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='pthemes_page_1_tr6']")).click(); Thread.sleep(1000);	
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 8
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr4']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='transitionstab_rtm_tr23']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='ptransition_page_1_tr30']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 9
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
		...
		// Question 11
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr1']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='infobv_rtm_tr21']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='printbv_rtm_tr13']")).click(); Thread.sleep(1000);	
		driver.findElement(By.xpath(".//*[@id='pprintlayout_page_1_tr1']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='printbv_rtm_tr10']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 12
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr6']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='slideshowtab_rtm_tr10']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='slideshow_tr2']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 13
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='begin_tr2']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='ppointer_page_1_tr1']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 14
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		...
		driver.findElement(By.xpath(".//*[@id='ppicture_page_1_tr0']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='pministyle_page_1_tr6']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 15
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		WebElement testt2 = driver.findElement(By.xpath(".//*[@id='begin_tr10']"));Thread.sleep(1000);
	    new Actions(driver).contextClick(testt2).perform();Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='ppicture_page_1_tr14']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='fppane1_tr9']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 16
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
		...
		// Question 17
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr2']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='inserttab_rtm_tr11']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='picturedb_tr4']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='picturedb_btn2']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 18 note
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr50']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='pshapes_page_1_tr42']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='begin_tr12']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 19
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
		...
		// Question 21
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr5']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='animationstab_rtm_tr8']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='applied_tr19']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='peffectoptions2_page_1_tr2']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 22
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
		...
		// Question 23
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		WebElement testt3 = driver.findElement(By.xpath(".//*[@id='begin_tr14']"));Thread.sleep(1000);
	    new Actions(driver).contextClick(testt3).perform();Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='ptext_page_1_tr26']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='ptext_page_4_tr0']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 24
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		WebElement testt4 = driver.findElement(By.xpath(".//*[@id='begin_tr13']"));Thread.sleep(1000);
	    new Actions(driver).contextClick(testt4).perform();Thread.sleep(2000);
		driver.findElement(By.xpath(".//*[@id='pdraw_page_1_tr0']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='pshapestyle_page_1_tr5']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 25
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
		...
		// Question 26
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr8']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='viewtab_rtm_tr16']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='zoomdb_spn0_input']")).clear();
		driver.findElement(By.xpath(".//*[@id='zoomdb_spn0_input']")).sendKeys("70");Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='zoomdb_btn1']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 27
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr2']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='inserttab_rtm_tr25']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='paudio_page_1_tr0']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='insertdb_txt0']")).sendKeys("Children");Thread.sleep(1000);
		new Actions(driver).sendKeys(Keys.ENTER).perform();
		driver.findElement(By.xpath(".//*[@id='searchdb_tr3']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='searchdb_btn1']")).click();Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 28
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr2']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='inserttab_rtm_tr37']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='pnewslide_page_1_tr1']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='newslide_tr11']")).click(); Thread.sleep(1000);
	    ...
	    wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
	    driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr6']")).click(); Thread.sleep(1000);
		driver.findElement(By.xpath(".//*[@id='slideshowtab_rtm_tr17']")).click(); Thread.sleep(1000);
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
		// Question 31
		wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(8000);
		...
		driver.findElement(By.xpath(".//*[@id='lblSecondCell12']/u/i")).click(); Thread.sleep(1000);
		// Answer the Question 32 in review 
	    wait.until(ExpectedConditions.textToBe(By.xpath(".//*[@id='scaleArea']/span/div[1]"),"Task Instructions"));Thread.sleep(6000);
	    driver.findElement(By.xpath(".//*[@id='hometab_rtm_tr22']")).click(); Thread.sleep(1000);
		//new Actions(driver).sendKeys(Keys.ENTER).perform();
		wait.until(ExpectedConditions.attributeToBe(By.id("btnAnswerComplete"),"disabled",""));
		driver.findElement(By.xpath(".//*[@id='btnAnswerComplete']")).click(); Thread.sleep(1000);
